...
CREATE TABLE IF NOT EXISTS `dang_ki_lop_tin_chi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ma_lop_tin_chi` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lich_hoc` (
  ...
  `ngay_hoc` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `gio_hoc` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(2, '02', 2, 17, 1623164106),
(3, '03', 4, 17, 1623166593),
(4, '04', 18, 17, 1623166849),
(5, '01', 17, 17, 1623166867);
...
INSERT INTO `lop_tin_chi` (`id`, `ten_lop`, `ma_mon_hoc`, `ma_giang_vien`, `ma_ki_hoc`, `ma_phong_hoc`, `created_at`) VALUES
(11, '1622967471224P21', '2', 4, 2, 1, 1623348491);
...
CREATE TABLE IF NOT EXISTS `sinh_vien` (
  ...
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `lop_hanh_chinh` (`lop_hanh_chinh`)
...
(1, 'Nguyễn Thiên Nam', 'nguyenthiennam@gmail.com', NULL, 'Bắc Thái', 0, 1622771151, '58297997238', 1622771151, 1622771151),
(2, 'Phan Trần Bảo Tuấn', 'phantranbaotuan@gmail.com', NULL, 'Lâm Đồng', 0, 1622771151, '66799938178', 1622771151, 1622771151),
(3, 'Trần Duy Bảo', 'tranduybao@gmail.com', NULL, 'Đắk Nông', 0, 1622771151, '98716891997', 1622771151, 1622771151),
...
(1, 'admin', 'mitto.hai.7356@gmail.com6', 0, '$2y$10$L0xLefcDfQHiS4d3wg/CE.dPmq6IQq5lYgCY4SJv0IDdcYRe/GDkO', 'cazH3uZa4-qu3--HMNwJk92DB024IJ0k', 1622739891, NULL, NULL, '::1', 1622739891, 1622739891, 0, 1623374087),
(2, 'nguyenthiennam@gmail.com', 'nguyenthiennam@gmail.com', NULL, '$2y$10$Bo6HjPQ9AXi0H.Cm9wSdjeKgBLHdy/5uq27g8Yx87d/TQEW1RWrsK', 'Vuye970pYTcf2MrW7vrVwZ6s17BjYi95', 1622826087, NULL, NULL, NULL, 1622826087, 1622826087, 0, NULL);
